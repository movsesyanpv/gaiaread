...
\end{figure}
%Здесь видно, что с увеличением расстояния компоненты вектора угловой скорости вращения Галактики, отвечающие за вращение вокруг осей $x$ и $y$ становятся близкими к нулю.  Это означает, что ось вращения близка к оси $z$.
\begin{figure}[h!]
